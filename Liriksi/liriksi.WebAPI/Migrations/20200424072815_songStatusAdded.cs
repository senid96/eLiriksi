...
{
    public partial class songStatusAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SongStatusId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Song_SongStatus_SongStatusId",
                        column: x => x.SongStatusId,
                        principalTable: "SongStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
